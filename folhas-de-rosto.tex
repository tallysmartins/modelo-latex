...
durante os bons anos que trabalhamos juntos.

\begin{resumo}{port}
  Apresentamos o ecossistema de software livre da plataforma ElixirBench com o objetivo
  de documentar as características da comunidade que rege este software no contexto
  de uma disciplina de um curso de computação. Esse relatório fornece
  insumos para que futuros alunos tenham informações esclarecidas sobre o funcionamento
  da comunidade e possam mais facilmente contribuir para o projeto.
\end{resumo}
